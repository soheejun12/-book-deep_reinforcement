...
class InputWrapper(gym.ObservationWrapper):
    ...
    def observation(self, observation):
        ...
        #np.moveaxis(array, 옮길차원, 옮겨질차원)
        new_obs = np.moveaxis(new_obs, 2, 0) #(c, h, w)
...
class Discriminator(nn.Module):
    def __init__(self, input_shape):
        ...
        self.conv_pipe = nn.Sequential(nn.Conv2d(in_channels=input_shape[0],
...
class Generator(nn.Module):
    def __init__(self, output_shape):
        ...
        self.pipe = nn.Sequential(nn.ConvTranspose2d(in_channels=LATENT_VECTOR_SIZE, 
